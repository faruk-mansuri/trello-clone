...
const MarketingPage = async () => {
  return (
    <div className='flex items-center justify-center flex-col tracking-wide'>
      <div
        className={cn(
      ...
      <div
        className={cn(
          'text-sm md:text-xl text-neutral-400 mt-4 max-w-xs md:max-w-2xl text-center tracking-normal',
          textFont.className
        )}
      >
